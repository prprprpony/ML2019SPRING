...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_case', default='test_case.csv', type=str)
    parser.add_argument('--output_name', default='m3ans.csv', type=str)
    parser.add_argument('--model_name', default='m3.pth', type=str)
