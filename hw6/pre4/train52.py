...
if len(sys.argv) == 2:
    ...
    model.add(Bidirectional(GRU(units=64, return_sequences=True, dropout=0.3,kernel_initializer='Orthogonal')))
    model.add(Bidirectional(GRU(units=32, return_sequences=True, dropout=0.3,kernel_initializer='Orthogonal')))
    model.add(Bidirectional(GRU(units=16, return_sequences=True, dropout=0.3,kernel_initializer='Orthogonal')))
    model.add(Bidirectional(GRU(units=8, return_sequences=False, dropout=0.3,kernel_initializer='Orthogonal')))
