...
if len(sys.argv) == 2:
    ...
    model.add(Bidirectional(GRU(units=128, return_sequences=True, dropout=0.2, recurrent_dropout=0.2, kernel_initializer='Orthogonal')))
    model.add(Bidirectional(GRU(units=128, return_sequences=False, dropout=0.2, recurrent_dropout=0.2, kernel_initializer='Orthogonal')))
